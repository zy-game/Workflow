...
const SERVICE_API = [
	...
	},
	{
		...
		methods: [{
			...
			parameters: [{
				name: "message",
				description: "Client response carrying the server request's rpcId."
			}],
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					...
					name: "discover",
					description: "interrogates one endpoint; must honor `request.signal`."
				}],
		...
		methods: [
			...
			},
			{
				...
				parameters: [{
					...
					name: "signal",
					description: "optional cancellation for the persistence reads."
				}],
	...
	},
	{
		...
		methods: [{
			...
			parameters: [{
				name: "provider",
				description: "UI-side implementation that collects answers."
			}],
