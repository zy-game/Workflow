...
export type SpeechV1AudioSpeechPostData = components.SpeechStreamAudioDelta | components.SpeechStreamDone | discriminatedUnionTypes.Unknown<"type">;
/**
 * Speech audio data.
 */
...
/** @internal */
export declare const SpeechV1AudioSpeechPostData$inboundSchema: z.ZodType<SpeechV1AudioSpeechPostData, unknown>;
export declare function speechV1AudioSpeechPostDataFromJSON(jsonString: string): SafeParseResult<SpeechV1AudioSpeechPostData, SDKValidationError>;
/** @internal */
