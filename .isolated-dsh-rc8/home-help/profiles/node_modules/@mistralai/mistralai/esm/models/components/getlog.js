...
/** @internal */
export const GetLog$inboundSchema = z.object({
...
export function getLogFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetLog$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'GetLog' from JSON`);
}
