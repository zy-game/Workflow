 ...
 */
import { completionChunkFromJSON, } from "../../models/components/completionchunk.js";
import { UsageInfo$outboundSchema, } from "../../models/components/usageinfo.js";
 ...
 */
export function parseSseChunks(rawSseText) {
    const chunks = [];
 ...
 */
export function accumulateChunksToResponseDict(chunks) {
    let responseId;
    let model;
    let usage;
